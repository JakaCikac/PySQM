...
def define_ephem_observatory():
    ...
    observatory.lat = config.observatory_latitude * ephem.pi / 180
    observatory.lon = config.observatory_longitude * ephem.pi / 180
    observatory.elev = config.observatory_altitude
    return observatory
...
class Observatory(object):
    ...
    def calculate_sun_altitude(self, observatory, timeutc):
        # Calculate Sun altitude
        observatory.date = ephem.date(timeutc)
        Sun = ephem.Sun(observatory)
        return (Sun.alt)
